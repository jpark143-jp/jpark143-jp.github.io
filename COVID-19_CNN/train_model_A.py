...
from PneumoniaNet.Simple_A_Net import PneumoniaNet  # This line is the only variable for each model.


model_name = 'Simple_A_Net' # This line is the only variable for each model.
...
model=Simple_A_Net.build(width=224,height=224,depth=3,classes=2)
opt= Adam
